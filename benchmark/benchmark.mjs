...
/**
 * Benchmark for the backends currently in pi-search extension.
...
async function main() {
  ...
  console.log("╔══════════════════════════════════════════════════════════╗");
  console.log("║     pi-search — Backend Benchmark (one at a time)       ║");
  console.log("╚══════════════════════════════════════════════════════════╝\n");
...
function generateReport(data) {
  ...
  emit("# 🔍 pi-search — Backend Benchmark Report");
  emit();
  ...
  emit("---\n");
  emit(`_Generated by pi-search benchmark on ${new Date().toISOString()}_`);
